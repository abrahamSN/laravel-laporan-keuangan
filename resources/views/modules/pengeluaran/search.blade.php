        ...
        <div class="box">
            <div class="box-header with-border">
                @if(Auth::user()->can(['pengeluaran-create']))
                    <a href="{{ url('/pengeluaran/add') }}" class="btn btn-sm btn-default">
                ...
                @endif
                <div class="box-tools">
                <form action="{{ url('pengeluaran/query') }}" method="GET">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align='center'>
                                <a class="image-popup-no-margins" href="{{asset('images/pengeluaran/'.$data->foto_bukti)}}">
                                    <img src="{{asset('images/pengeluaran/'.$data->foto_bukti)}}" width="60" height="60" class="img-circle" alt="" />
                                </a>
                            </td>
                            <td align='center'>
                                @if(Auth::user()->can(['pengeluaran-edit']))
                                <button onclick="window.location.href='{{ url("pengeluaran/edit", $data->id) }}'" type="button" class="btn btn-sm btn-default">
                                    <span class="glyphicon glyphicon-eye-open"></span>
                                </button>
                                @endif
                                @if(Auth::user()->can(['pengeluaran-delete']))
                                <button type="button" class="btn btn-sm btn-default" onclick="return hapus('{{ url("pengeluaran/delete", $data->id) }}');">

        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form role="form" method="POST" action="{{ url('pengeluaran/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('total') ? ' has-error' : '' }}">
                                ...
                                <input id="total" type="text" name="total" value="{{ old('total') }}" class="form-control" placeholder="Total">
                                @if ($errors->has('total'))
                                    <span class="help-block">

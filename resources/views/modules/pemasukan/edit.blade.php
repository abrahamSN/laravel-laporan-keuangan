        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form role="form" method="POST" action="{{ url('pemasukan/update', $data->id) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('jasa') ? ' has-error' : '' }}">
                                ...
                                <select class="form-control select2" name="jasa" id="jasa" style="width: 100%;">
                                    ...
                                    @foreach($jasa as $js)
                                        <option value="{{ $js->id }}" {{ (old("jasa", $data->jasa_id) == "$js->id" ? "selected":"") }}>{{ $js->nama_jasa }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('jasa'))
                            ...
                            <div class="form-group{{ $errors->has('foto_bukti') ? ' has-error' : '' }}">
                                ...
                                <br/>
                                <img src="{{ asset('images/pemasukan/'.$data->foto_bukti) }}" id="showgambar" style="max-width:200px;max-height:200px;" />
                                <br/>
                                <br/>

    ...
    <div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools">
                <form action="{{ url('pemasukan/report') }}" method="GET">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Filter Cetak Pemasukan</h4>
              </div>
              <form action="{{ url('pemasukan/pdf') }}" method="GET">
...
<!-- bootstrap datepicker -->
    ...
    var chart = new Chart(ctx, {
        ...
        options: {
                ...
                title:{
                    display:true,
                    text:'Grafik Pemasukan Di Tahun ' + {{$year}}
                },
                tooltips: {
                    callbacks: {

        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form role="form" method="POST" action="{{ url('jasa/update', $data->id) }}">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('nama_jasa') ? ' has-error' : '' }}">
                                ...
                                <input id="nama_jasa" type="text" class="form-control" name="nama_jasa" value="{{ old('nama_jasa', $data->nama_jasa) }}" placeholder="Nama jasa">
                            ...
                            <div class="form-group{{ $errors->has('keterangan_jasa') ? ' has-error' : '' }}">
                                ...
                                <textarea id="keterangan_jasa" name="keterangan_jasa" class="form-control" rows="6" placeholder="Keterangan jasa ...">{{ old('keterangan_jasa', $data->keterangan) }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('harga_jasa') ? ' has-error' : '' }}">
                                ...
                                <input id="harga_jasa" type="text" name="harga_jasa" value="Rp. {{ old('harga_jasa', number_format($data->harga_jasa,0,',','.')) }}" class="form-control" placeholder="Harga jasa">
